...
const Socials = () => { // Accept the scroll instance as a prop
  ...
  return (
    <footer data-scroll-section id="socials" className="font-outfit w-[100%] h-[40vh] md:h-[100%] bg-[white] rounded-lg shadow">
      <div className="w-full max-w-screen-xl mx-auto p-2 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <ul className="flex flex-wrap items-center justify-center mt-6 md:mt-0 mb-6 text-md font-medium text-gray-500 sm:mb-0">
            <li>
